            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/color/list') }}" class="btn btn-primary"><i class="fa fa-backward"></i></a>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                            ...
                            <form action="" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="" value="{{ old('name') }}" placeholder="Enter Color Name" required>
                                    </div>

                                    <div class="form-group">
                                        <label>Color Code <span style="color:red">*</span> </label>
                                        <input type="color" class="form-control" name="code" id="" value="{{ old('code') }}" placeholder="Enter Color Code" required>
                                    </div>
