                            ...
                            <form action="" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="" value="{{ old('name', $getRecord->name) }}" placeholder="Enter Shipping Charge Name" required>
                                    </div>

                                    <div class="form-group">
                                        <label>Price <span style="color:red">*</span> </label>
                                        <input type="text" class="form-control" name="price" id="" value="{{ old('price', $getRecord->price) }}" placeholder="Enter Price" required>
                                    </div>
